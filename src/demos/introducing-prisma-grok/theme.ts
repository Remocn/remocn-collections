...
// Aliases used by scenes/components — Inter carries display + UI on the site
// (Mona Sans isn't on Google Fonts), so display and sans share one family.
export const DISPLAY = SANS;
export const DISPLAY_FAMILY = SANS_FAMILY;
